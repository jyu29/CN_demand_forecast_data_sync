...
zip -x ./src/main_data_ingestion.py -x \*libs\* -r main_data_ingestion_src.zip ./src/
...
spark-submit --deploy-mode client --master yarn \
	...
	--py-files main_data_ingestion_src.zip \
	./src/main_data_ingestion.py -c $technical_conf_file -l ./conf/loggin-console.json -s $2 -p $3
